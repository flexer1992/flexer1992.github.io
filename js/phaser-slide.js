 ...
 *  https://github.com/netgfx/PhaseSlider
 */
    ...
    return {
        createSlider: function (options) {
            ...
            _this.options = {
                ...
                _onNextCallbackNew: options.onNextCallbackNew || false,
                _onPrevCallbackNew: options.onPrevCallbackNew || false,
           ...
           // draggableSprite.input.enableSnap(_this.options._width, _this.options._height, true, true);
            ...
            if (_this.options._showHandles === true) {
                ...
                _this.chevronRight.inputEnabled = true;
                _this.chevronRight.events.onInputDown.add(function (e, pointer) {
                    ...
                    if (_this.tweenObj.isRunning !== true) {
                        ...
                        if(_this.options._onNextCallbackNew)
                        {
                            _this.options._onNextCallbackNew();
                        }
                ...
                if (_this.options._customHandlePrev === "") {
                    _this.chevronLeft = game.add.image(0, 0, "slider_chevron_left");
                ...
                _this.chevronLeft.inputEnabled = true;
                _this.chevronLeft.events.onInputDown.add(function (e, pointer) {
                    ...
                    if (_this.tweenObj.isRunning !== true) {
                        ...
                        if(_this.options._onPrevCallbackNew)
                        {
                            _this.options._onPrevCallbackNew();
                        }
            ...
            if (_this.options._showHandles === true) {
                _this.sliderControlsGroup.add(_this.chevronRight);
                _this.sliderControlsGroup.add(_this.chevronLeft);
            }
        ...
        destroy : function()
        {
            for (var i = 0; i < _this.options._objects.length; i++)
            {
                _this.options._objects[i].destroy();
            }

           _this.sliderControlsGroup.destroy();
        }
